...
from discord import app_commands  # Dieser Import ist notwendig
import yaml
import os
...
def load_config():
    ...
    with open(CONFIG_FILE, "r") as f:
        ...
        # Überprüfen, ob die 'channels' Struktur vorhanden ist, andernfalls initialisieren
...
async def setup(bot):
    # Stelle sicher, dass die Klasse richtig registriert wird
